  ...
  children: [
    {
      ...
      type: 'item',
      // url: 'https://www.newboomerangsite.com',
      url: 'https://www.theboomer.net', // Full external URL
      icon: icons.IconDeviceDesktop, // Reusing the same icon
      breadcrumbs: false,
      target: '_blank' // Ensures the link opens in a new tab
      // target: false // Ensures the link opens in a new tab
    },
    {
      id: 'default',
      title: 'Dashboard',
